...
import br.sistema.sistemadeacg.models.Status;
import br.sistema.sistemadeacg.repository.AnexoRepository;
import br.sistema.sistemadeacg.repository.AtividadeRepository;
import br.sistema.sistemadeacg.repository.AvaliacaoRepository;
import br.sistema.sistemadeacg.repository.CurriculoRepository;
import br.sistema.sistemadeacg.repository.GrupoRepository;
import br.sistema.sistemadeacg.repository.SolicitacaoRepository;
...
public class AvaliacaoController {
    ...
    public ResponseEntity postAvaliacao(@RequestBody AvaliacaoFormulario avaliacao, @PathVariable long id) throws Exception{
