                        ...
                        <td>
                          <div>
                            <Button
                              ...
                              onClick={() => {
                                window.open(`http://localhost:8888/anexos/${documento.nome}`, "_blank", "noopener");
                              }}
                            >
                              {documento.nome}
                            </Button>
                      ...
                      <tr>
                        ...
                        <td>
                          <Form.Control
                            ...
                            type="number"
                            min="1"
                            onChange={(e) => setCargaHorariaAprov(e.target.value.replace(/\D/g, "").slice(0, 5))}
                          />
                        </td>
                      </tr>
                      <tr>
                  ...
                  {deferido === "indef" ? (
                    <>
                      <tr>
                        <td>Observações*</td>
                        <td>
                          <Form.Control required as="textarea" value={obs} onChange={(e) => setObs(e.target.value)} />
                        </td>
                      </tr>
                    </>
                  ) : null}
